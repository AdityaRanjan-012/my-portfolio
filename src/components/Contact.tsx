          ...
          <div ref={infoRef} className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 glass rounded-lg hover:shadow-glow-primary transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">adityaranjan3003@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 glass rounded-lg hover:shadow-glow-secondary transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">+91 7209640023</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 glass rounded-lg hover:shadow-glow-primary transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">IIIT Guwahati, India</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="https://github.com/AdityaRanjan-012" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-gradient-primary rounded-lg flex items-center justify-center hover:shadow-glow-primary transition-all duration-300 hover:scale-110">
                  <GithubLogo size={20} className="text-primary-foreground" />
                </a>
                <a href="https://www.linkedin.com/in/aditya-ranjan-244162258/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-gradient-secondary rounded-lg flex items-center justify-center hover:shadow-glow-secondary transition-all duration-300 hover:scale-110">
