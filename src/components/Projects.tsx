  ...
  const projects = [
    {
      ...
      description: "MERN stack app to locate nearby hospitals and book ambulances in real-time. Developed using the Haversine formula for geolocation-based hospital search within a defined radius. Built real-time dashboards for users and hospital admins using Socket.io. Integrated OAuth login and designed a responsive emergency booking interface.",
      image: "/Images/project-1.jpg",
      tech: ["React", "Node.js", "Express.js", "MongoDB", "Socket.io", "Geolocation APIs", "OAuth"],
      liveUrl: "",
      githubUrl: ""
    },

    {
      ...
      description: "User-friendly system to streamline college operations and reduce manual errors. Features include user authentication, role-based access control for secure access, real-time notification system for announcements and events, and comprehensive usage guidelines for easy onboarding and maintenance.",
    ...
    {
      id: 3,
      title: "SpendiQ - Personal Finance App",
      description: "Full-stack personal finance web app to track expenses, categorize transactions, and view spending analytics. Features include secure JWT-based authentication, MongoDB-backed storage for multi-user transaction data, receipt upload with OCR services, and interactive dashboard with charts showing category-wise spending and monthly trends.",
      image: "/Images/project-3.jpg",
      tech: ["React", "Node.js", "Express.js", "MongoDB", "Redis", "JWT", "OCR Services"],
      liveUrl: "",
      githubUrl: ""
    }
