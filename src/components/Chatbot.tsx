  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      if (userInput.includes("services")) {
        reply = "Aditya Ranjan offers services in frontend, backend development, animations, and AI integration. Would you like a portfolio link?";
      } else if (userInput.includes("contact")) {
        reply = "You can contact Aditya Ranjan via the contact form above or email him directly at adityaranjan3003@gmail.com";
      } else if (userInput.includes("react") || userInput.includes("gsap")) {
        reply = "Yes! Aditya Ranjan uses React, GSAP, and even WebGL to build stunning UIs.";
      } else if (userInput.includes("project")) {
        reply = "Tell me more about your project! Aditya Ranjan can help with frontend, backend, UI/UX design, and building full-stack web applications.";
      }
