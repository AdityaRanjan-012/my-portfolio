        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative w-80 h-80 mx-auto lg:mx-0">
              ...
              <div className="relative w-full h-full glass rounded-full p-2 hover:shadow-glow-primary transition-all duration-500 group">
                <div className="w-full h-full cursor-pointer rounded-full overflow-hidden bg-gradient-secondary">
                  <img src="/Images/profileLogo.jpg" alt="Aditya Ranjan - Full Stack Developer" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                </div>
              </div>
          ...
          <div ref={contentRef} className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              I'm a BTech Computer Science student at IIIT Guwahati  specializing in full-stack web development using the MERN stack. I have hands-on experience building scalable applications with React.js, Node.js, Express.js, and databases like MongoDB and MySQL. I'm proficient in creating secure authentication systems, responsive UIs, and implementing real-time features using Socket.io.
            </p>

            <p className="text-lg text-muted-foreground leading-relaxed">
              I'm passionate about solving real-world problems with practical solutions. I've solved 550+ LeetCode questions and am currently shortlisted in Flipkart Grid 6.0. I actively contribute to open-source projects and stay updated with the latest web technologies and best practices.
            </p>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              <div className="glass px-4 py-2 rounded-lg">
                <span className="text-secondary-glow font-medium">550+</span>
                <span className="text-muted-foreground ml-1">LeetCode Problems</span>
              </div>
              <div className="glass px-4 py-2 rounded-lg">
                <span className="text-accent-glow font-medium">IIIT</span>
                <span className="text-muted-foreground ml-1">BTech CSE Student</span>
              </div>
            </div>
          </div>
        </div>
